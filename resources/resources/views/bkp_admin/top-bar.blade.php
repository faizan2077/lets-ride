...
<section class="main_content dashboard_part large_header_bg">
    ...
    <a href="#"><img src="/publicimg/staf/2.png" alt=""></a>
    </div>
    ...
    <div class="single_notify d-flex align-items-center">
    <div class="notify_thumb">
    <a href="#"><img src="/publicimg/staf/4.png" alt=""></a>
    </div>
    <div class="notify_content">
    ...
    <div class="single_notify d-flex align-items-center">
    <div class="notify_thumb">
    <a href="#"><img src="/publicimg/staf/3.png" alt=""></a>
    </div>
    <div class="notify_content">
    ...
    <div class="single_notify d-flex align-items-center">
    <div class="notify_thumb">
    <a href="#"><img src="/public/img/staf/2.png" alt=""></a>
    </div>
    <div class="notify_content">
    <a href="#"><h5>Cool Marketing </h5></a>
    <p>Lorem ipsum dolor sit amet</p>
    ...
    <div class="single_notify d-flex align-items-center">
    <div class="notify_thumb">
    <a href="#"><img src="{{ asset('/public/img/staf/4.png') }}" alt=""></a>
    </div>
    <div class="notify_content">
    <a href="#"><h5>Awesome packages</h5></a>
    <p>Lorem ipsum dolor sit amet</p>
    ...
    <img src="{{ url('/public/img/transfer/4.png') }}" alt="#">
    </div>
