    ...
    <table class="table table-striped project-orders-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a class="btn btn-danger btn-sm btn-icon-text delete-confirm" href="{{ route('delete-passenger-details', ['id' => $details->id]) }}"><i class="typcn typcn-delete-outline btn-icon-append" >Delete</i></a></td>
