          ...
          <div class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a class="btn btn-danger btn-sm btn-icon-text delete-confirm" href="{{ route('delete-customer', ['id' => $data->id]) }}"><i class="typcn typcn-delete-outline btn-icon-append" >Delete</i></a></td>
