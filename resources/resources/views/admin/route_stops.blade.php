    ...
    <table class="table table-striped project-orders-table">
            <thead>
              <tr>
                ...
                <th scope="col">Buss stop title</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a class="btn btn-danger btn-sm btn-icon-text delete-confirm" href="{{ route('delete-route-stop', ['id' => $routes->id]) }}"><i class="typcn typcn-delete-outline btn-icon-append" >Delete</i></a></td>
                {{-- <td><a href="{{ route('routeStops', ['routeId' => $routes->route_id]) }}">View Bus Stops</a></td> --}}
              </tr>
