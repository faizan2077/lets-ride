        ...
        @endif
          ...
          <div class="row">
            ...
            <tbody>
                ...
                <td><a class="btn btn-danger btn-sm btn-icon-text delete-confirm" href="{{ route('delete-bookings', ['id' => $bookings->id]) }}"><i class="typcn typcn-delete-outline btn-icon-append" >Delete</i></a></td>
              </tr>
