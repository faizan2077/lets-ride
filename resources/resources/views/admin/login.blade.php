...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('/public/images/fav@2x.png')}}" />
</head>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="{{asset('/public/images/logo@2x.png')}}" alt="logo">
              </div>
              <h4>Hello! let's get started</h4>
              <h6 class="font-weight-light">Sign in to continue.</h6>
              <form class="form_styling"   method="POST" action="{{ url('/manage-admin/admin_login') }}">
                @csrf
