    ...
    <table class="table table-striped project-orders-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <a class="btn btn-success btn-sm btn-icon-text " href="{{ route('edit-stops', ['id' => $stops->id]) }}"><span class="material-symbols-outlined">
                      edit
                      </span></a>
                    <a class="btn btn-danger btn-sm btn-icon-text delete-confirm" href="{{ route('delete-stops', ['id' => $stops->id]) }}"><i class="typcn typcn-delete-outline btn-icon-append" >Delete</i></a></td>
